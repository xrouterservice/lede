...
- `Build_K3(A1)` Branch:
  - Building Status: ![Build_K3](https://github.com/xrouterservice/lede/workflows/Build_K3/badge.svg?branch=master)
#  - Download Firmwares: [Actions/R619AC](https://github.com/RealKiro/Actions-OpenWrt/actions?query=is%3Asuccess+branch%3Amaster).

- `X64/X86` Branch:
  - Building Status: ![Build_x86](https://github.com/xrouterservice/lede/workflows/Build_x86/badge.svg？branch=master)
...
#![Build_K3](https://github.com/xrouterservice/lede/workflows/Build_K3/badge.svg)
#![Build_x86](https://github.com/xrouterservice/lede/workflows/Build_x86/badge.svg)
