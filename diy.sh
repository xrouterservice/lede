...
# git clone https://github.com/ntlf9t/luci-app-dnspod.git package/mine/luci-app-dnspod
...
git clone https://github.com/jerrykuku/lua-maxminddb.git  package/mine/lua-maxminddb #git lua-maxminddb 依赖
